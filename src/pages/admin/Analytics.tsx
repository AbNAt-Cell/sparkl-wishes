...
import { TrendingUp, Users, Eye, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          Analytics tables (item_views, site_visits) are not yet configured. 
          Contact support to enable detailed analytics tracking.
        </AlertDescription>
      </Alert>
